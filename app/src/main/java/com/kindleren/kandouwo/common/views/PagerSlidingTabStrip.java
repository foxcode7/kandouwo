...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        int indicatorResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsIndicatorRes, 0);
        if (indicatorResId != 0) {
            indicatorDrawable = context.getResources().getDrawable(indicatorResId);
        }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                ...
                addTab(i, ((LayoutTabProvider) pager.getAdapter()).getTitleView(i));
            } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (indicatorDrawable != null) {
            ((TextView) currentTab).setTextColor(tabTextColor.withAlpha((int) (500 * Math.abs(currentPositionOffset - 0.5))));
        }
        ...
        if (currentPositionOffset >= 0f && currentPosition < tabCount - 1) {
            ...
            //change alpha
            if (indicatorDrawable != null) {
                ((TextView) nextTab).setTextColor(tabTextColor.withAlpha((int) (500 * Math.abs(currentPositionOffset - 0.5))));
            }
    ...
    public static interface LayoutTabProvider {
