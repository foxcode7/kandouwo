 ...
 *
 * 带清除按钮的AutoCompleteTextView
 *
 *         这个view继承自AutoCompleteTextView
...
public class AutoCompleteTextViewWithClearButton extends AutoCompleteTextView {
    ...
    private void init() {
        ...
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                AutoCompleteTextViewWithClearButton editText = AutoCompleteTextViewWithClearButton.this;
                ...
                if (event.getX() > editText.getWidth()
                    ...
                    if (mClearButtonOnClickListener != null) {
                        mClearButtonOnClickListener.onClearButtonClick();
                    }
        ...
        addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                AutoCompleteTextViewWithClearButton.this.handleClearButton();
            }
        });
    ...
    public void setClearButtonOnClickListener(
